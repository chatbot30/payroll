<?php include 'server_add_emp.php';?>
...
<body>
	...
	<div class="header">
		...
		<h2 id="emp_reg" >Employee Registration</h2>
	...
	<form  method='POST' action="add_emp.php">	
		...
		<input type="number" min="1" name="emp_id" id= "empid" placeholder="Enter employee Id" value="<?php echo $emp_id; ?>" required>
		...
		<button  name="register" id="register" >Add Record</button>
